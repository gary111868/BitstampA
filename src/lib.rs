...
#[derive(Debug)]
pub struct BitstampAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BitstampAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BitstampAPI processing");
    
    let mut processor = BitstampAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BitstampAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BitstampAPIProcessor::new(false);
